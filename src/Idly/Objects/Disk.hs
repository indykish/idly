...
{-| Implementation of the Idly Disk config object.

-}

module Idly.Objects.Disk where
...
import           Text.JSON                  (JSValue (..), readJSON, showJSON)
import qualified Text.JSON                  as J

import           Idly.JSON                  (Container, fromObj)
import           Idly.THH
import           Idly.THH.Field
import           Idly.Types
import           Idly.Utils.Validate
